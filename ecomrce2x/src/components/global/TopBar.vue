  ...
  <b-container fluid class="position-relative">
    <b-row class="py-1 px-xl-5">
      ...
      <b-col class="lg-6 text-center text-lg-end">
        <b-dropdown id="dropdown-1" text="My Account" class="me-2" right toggle-class="shadow-none rounded-0">
          ...
          <b-button class="w-100 mx-1" v-if="user" @click="logout()">Sign Out</b-button>
        </b-dropdown>
        <b-dropdown id="dropdown-1" text="EN" class="text-secondary bg-light" right toggle-class="shadow-none rounded-0">
        ...
        <div class="d-lg-none d-inline">
          <b-button size="lg" variant="none" class="border-0 pe-0">
            <b-icon icon="cart-fill" variant="secondary" class="icon-cart"></b-icon>
          </b-button>
          <span class="text-secondary fw-bold"> 0,000 DT t22</span>
        </div>
      </b-col>
    </b-row>
  </b-container>
