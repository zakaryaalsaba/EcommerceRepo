...
class DoorDashClient {
    constructor(tokenContext) {
        ...
        this._apiClient = new api_1.DeliveryApi();
    }
    /**
     * Cancel delivery
    ...
    deliveryQuoteAccept(externalDeliveryId, deliveryQuoteAcceptInput = {}, options) {
        return this._wrap(this._apiClient.deliveryQuoteAccept(externalDeliveryId, deliveryQuoteAcceptInput, this._generateOptions(options)));
    }
    /**
